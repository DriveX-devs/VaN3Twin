...
asn_TYPE_member_t asn_MBR_ResponseContainer_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ResponseContainer, manouevreResponse),
		...
		{ ATF_NOFLAGS, 0, offsetof(struct ResponseContainer, coordinatorID),
...
static const int asn_MAP_ResponseContainer_oms_1[] = { 2, 3 };
...
static const asn_TYPE_tag2member_t asn_MAP_ResponseContainer_tag2el_1[] = {
	...
	{ (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* coordinatorID */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* declineReason */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* submaneuvres */
};
